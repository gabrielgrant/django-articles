...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Article.last_modified'
        db.add_column('articles_article', 'last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime.now(), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Article.last_modified'
        db.delete_column('articles_article', 'last_modified')
